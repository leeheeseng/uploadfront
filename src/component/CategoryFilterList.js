...
import ProductDisplayComponent from './table/ProductDisplayComponent';
...
const CategoryProductList = () => {
  ...
  useEffect(() => {
    ...
    fetchProducts();
  }, [topCategoryId, subCategoryId, currentPage, itemsPerPage]);
  ...
  const handleSelectAll = (e) => {
    ...
    const newSelectedProducts = isChecked ? currentItems.map(p => p.bookId) : [];
    ...
    <div className="category-filter-container">
      <section className="display-options-section">
        <div className="results-count">
          총 <strong>{totalItems}</strong>개 상품   
        </div>
